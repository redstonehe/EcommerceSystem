...
namespace VMall.Data
{
    ...
    public partial class SearchHistories
    {
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateSearchHistory(uid, word, updateTime);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ClearExpiredSearchHistory();
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetSearchWordStatListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetSearchWordStatCount(word);
        }
    }
}
