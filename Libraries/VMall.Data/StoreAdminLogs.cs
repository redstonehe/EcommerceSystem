...
namespace VMall.Data
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        public static List<StoreAdminLogInfo> GetStoreAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetStoreAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreAdminLogCount(condition);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteStoreAdminLogById(logIdList);
        }
    }
}
