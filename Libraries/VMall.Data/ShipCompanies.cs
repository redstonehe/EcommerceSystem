...
namespace VMall.Data
{
    ...
    public partial class ShipCompanies
    {
        ...
        public static List<ShipCompanyInfo> GetShipCompanyList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetShipCompanyList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetShipCompanyCount();
        }
        ...
        public static ShipCompanyInfo GetShipCompanyById(int shipCoId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetShipCompanyById(shipCoId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateShipCompany(shipCompanyInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateShipCompany(shipCompanyInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteShipCompanyById(shipCoId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetShipCoIdByName(shipCoName);
        }
    }
}
