...
namespace VMall.Data
{
    ...
    public partial class Brands
    {
        ...
        public static BrandInfo GetBrandById(int brandId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetBrandById(brandId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateBrand(brandInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateBrand(brandInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteBrandById(brandId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandListCondition(brandName);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetBrandIdByName(brandName);
        }
        ...
        public static List<CategoryInfo> GetBrandCategoryList(int brandId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetBrandCategoryList(brandId);
            while (reader.Read())
            {
        ...
        public static List<BrandInfo> GetBrandList(int pageSize, int pageNumber, string brandName)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetBrandList(pageSize, pageNumber, brandName);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetBrandCount(brandName);
        }
    }
}
