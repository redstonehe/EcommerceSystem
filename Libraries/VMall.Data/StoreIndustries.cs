...
namespace VMall.Data
{
    ...
    public partial class StoreIndustries
    {
        ...
        public static List<StoreIndustryInfo> GetStoreIndustryList()
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetStoreIndustryList();
            while (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateStoreIndustry(storeIndustryInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateStoreIndustry(storeIndustryInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteStoreIndustryById(storeIid);
        }
    }
}
