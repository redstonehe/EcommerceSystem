...
namespace VMall.Data
{
    ...
    public partial class Categories
    {
        ...
        public static CategoryInfo BuildCategoryFromReader(IDataReader reader)
        {
            ...
            categoryInfo.ChannelId = reader["channelid"].ToString();
            return categoryInfo;
        }
        ...
        public static List<CategoryInfo> GetCategoryList()
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCategoryList();
            while (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateCategory(categoryInfo);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.CreateCategory(categoryInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteCategoryById(cateId);
        }
        ...
        public static List<BrandInfo> GetCategoryBrandList(int cateId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCategoryBrandList(cateId);
            while (reader.Read())
            {
        ...
        public static List<AttributeGroupInfo> GetAttributeGroupListByCateId(int cateId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeGroupListByCateId(cateId);
            while (reader.Read())
            {
        ...
        public static AttributeGroupInfo GetAttributeGroupById(int attrGroupId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeGroupById(attrGroupId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteAttributeGroupById(attrGroupId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetAttrGroupIdByCateIdAndName(cateId, name);
        }
        ...
        public static List<AttributeInfo> GetAttributeListByCateId(int cateId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeListByCateId(cateId);
            while (reader.Read())
            {
        ...
        {
            List<AttributeInfo> attributeList = new List<AttributeInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeListByAttrGroupId(attrGroupId);
            while (reader.Read())
            {
                AttributeInfo attributeInfo = BuildAttributeFromReader(reader);
                attributeList.Add(attributeInfo);
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetAttributeList(cateId, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetAttributeListSort(sortColumn, sortDirection);
        }
        ...
        {
            List<AttributeInfo> attributeList = new List<AttributeInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetFilterAttributeListByCateId(cateId);
            while (reader.Read())
            {
                AttributeInfo attributeInfo = BuildAttributeFromReader(reader);
                attributeList.Add(attributeInfo);
        ...
        public static AttributeInfo GetAttributeById(int attrId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeById(attrId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateAttribute(attributeInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateAttribute(attributeInfo, attrGroupId, attrGroupName, attrGroupDisplayOrder);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteAttributeById(attrId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetAttrIdByCateIdAndName(cateId, attributeName);
        }
        ...
        public static List<AttributeValueInfo> GetAttributeValueListByAttrId(int attrId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeValueListByAttrId(attrId);
            while (reader.Read())
            {
        ...
        public static AttributeValueInfo GetAttributeValueById(int attrValueId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAttributeValueById(attrValueId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateAttributeValue(attributeValueInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteAttributeValueById(attrValueId);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateAttributeValue(attributeValueInfo);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetAttributeValueIdByAttrIdAndValue(attrId, attrValue);
        }
    }
}
