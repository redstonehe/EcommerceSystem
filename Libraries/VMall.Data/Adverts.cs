...
namespace VMall.Data
{
    ...
    public partial class Adverts
    {
        ...
        public static List<AdvertPositionInfo> GetAdvertPositionList(int pageSize, int pageNumber, string title)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAdvertPositionList(pageSize, pageNumber,title);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetAdvertPositionCount(title);
        }
        ...
        {
            List<AdvertPositionInfo> advertPositionList = new List<AdvertPositionInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAllAdvertPosition();
            while (reader.Read())
            {
                AdvertPositionInfo advertPositionInfo = BuildAdvertPositionFromReader(reader);
                advertPositionList.Add(advertPositionInfo);
        ...
        {
            VMall.Core.BMAData.RDBS.CreateAdvertPosition(advertPositionInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateAdvertPosition(advertPositionInfo);
        }
        ...
        public static AdvertPositionInfo GetAdvertPositionById(int adPosId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAdvertPositionById(adPosId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteAdvertPositionById(adPosId);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateAdvert(advertInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateAdvert(advertInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteAdvertById(adId);
        }
        ...
        public static AdvertInfo AdminGetAdvertById(int adId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetAdvertById(adId);
            if (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetAdvertList(pageSize, pageNumber, adPosId,title);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetAdvertCount(adPosId,title);
        }
        ...
        public static List<AdvertInfo> GetAdvertList(int adPosId, DateTime nowTime)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetAdvertList(adPosId, nowTime);
            while (reader.Read())
            {
