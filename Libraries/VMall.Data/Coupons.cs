...
namespace VMall.Data
{
    ...
    public partial class Coupons
    {
        ...
        public static CouponTypeInfo BuildCouponTypeFromReader(IDataReader reader)
        {
            ...
            couponTypeInfo.ChannelId = reader["channelid"].ToString();
        ...
        public static CouponInfo BuildCouponFromReader(IDataReader reader)
        {
            ...
            couponInfo.ValidTime = TypeHelper.ObjectToDateTime(reader["validtime"]);
            couponInfo.ChannelId = reader["channelid"].ToString();
            return couponInfo;
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateCouponType(couponTypeInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteCouponTypeById(couponTypeIdList);
        }
        ...
        public static CouponTypeInfo GetCouponTypeById(int couponTypeId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCouponTypeById(couponTypeId);
            if (reader.Read())
            {
        ...
        {
            CouponTypeInfo couponTypeInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetCouponTypeById(couponTypeId);
            if (reader.Read())
            {
                couponTypeInfo = BuildCouponTypeFromReader(reader);
            }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.ChangeCouponTypeState(couponTypeId, state);
        }
        ...
        public static List<CouponTypeInfo> GetSendingPromotionCouponTypeList(int storeId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetSendingPromotionCouponTypeList(storeId);
            while (reader.Read())
            {
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetSendingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetUsingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(couponTypeIdList);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.CreateCoupon(couponInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteCouponById(idList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistCouponSN(couponSN);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetSendCouponCount(couponTypeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetSendUserCouponCount(uid, couponTypeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetTodaySendUserCouponCount(uid, couponTypeId, today);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetCouponList(uid, type);
        }
        ...
        public static CouponInfo GetCouponByCouponId(int couponId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCouponByCouponId(couponId);
            if (reader.Read())
            {
        ...
        {
            CouponInfo couponInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCouponByCouponSN(couponSN);
            if (reader.Read())
            {
                couponInfo = BuildCouponFromReader(reader);
            }
        ...
        {
            VMall.Core.BMAData.RDBS.UseCoupon(couponId, oid, time, ip);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ActivateAndUseCoupon(couponId, uid, oid, time, ip);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ActivateCoupon(couponId, uid, time, ip);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ReturnUserOrderUseCoupons(oid);
        }
        ...
        public static List<CouponInfo> GetUserOrderSendCouponList(int oid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetUserOrderSendCouponList(oid);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponId(couponIdList);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.AddCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.DeleteCouponProductByRecordId(recordIdList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsSameCouponType(couponTypeId, pidList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(recordIdList);
        }
    }
}
