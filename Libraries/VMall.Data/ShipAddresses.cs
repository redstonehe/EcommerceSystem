...
namespace VMall.Data
{
    ...
    public partial class ShipAddresses
    {
        ...
        {
            int saId = VMall.Core.BMAData.RDBS.CreateShipAddress(shipAddressInfo);
            if (_usernosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateShipAddress(shipAddressInfo);
            if (_usernosql != null)
                _usernosql.DeleteFullShipAddressList(shipAddressInfo.Uid);
        }
        ...
        public static List<FullShipAddressInfo> GetFullShipAddressList(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                if (fullShipAddressList == null)
                {
                    ...
                    IDataReader reader = VMall.Core.BMAData.RDBS.GetFullShipAddressList(uid);
                    while (reader.Read())
                    {
        ...
        public static int GetShipAddressCount(int uid)
        {
            ...
            return VMall.Core.BMAData.RDBS.GetShipAddressCount(uid);
        }
        ...
        public static FullShipAddressInfo GetDefaultFullShipAddress(int uid)
        {
            ...
            {
                IDataReader reader = VMall.Core.BMAData.RDBS.GetDefaultFullShipAddress(uid);
                if (reader.Read())
                {
        ...
        public static FullShipAddressInfo GetFullShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = VMall.Core.BMAData.RDBS.GetFullShipAddressBySAId(saId);
                if (reader.Read())
                {
                    fullShipAddressInfo = BuildFullShipAddressFromReader(reader);
                }
        ...
        public static ShipAddressInfo GetShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = VMall.Core.BMAData.RDBS.GetShipAddressBySAId(saId);
                if (reader.Read())
                {
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.DeleteShipAddress(saId, uid);
            if (_usernosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateShipAddressIsDefault(saId, uid, isDefault);
            if (_usernosql != null)
