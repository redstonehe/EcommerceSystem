...
namespace VMall.Data
{
    ...
    public partial class ProductReviews
    {
        ...
        public static ProductReviewInfo GetProductReviewById(int reviewId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductReviewById(reviewId);
            if (reader.Read())
            {
        ...
        {
            ProductReviewInfo productReviewInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetProductReviewById(reviewId);
            if (reader.Read())
            {
                productReviewInfo = BuildProductReviewFromReader(reader);
            }
        ...
        {
            VMall.Core.BMAData.RDBS.ReviewProduct(productReviewInfo);
            if (_ordernosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteProductReviewById(reviewId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductReviewList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductReviewListCondition(storeId, pid,pname,type, message, startTime, endTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductReviewListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductReviewCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductReviewReplyList(reviewId);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsVoteProductReview(reviewId, uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.ChangeProductReviewState(reviewId, state);
        }
        ...
        public static List<ProductReviewInfo> GetUserProductReviewList(int uid, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetUserProductReviewList(uid, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetUserProductReviewCount(uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductReviewCount(pid, type);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductReviewList(startTime, endTime);
        }
    }
}
