...
namespace VMall.Data
{
    ...
    public partial class OrderActions
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateOrderAction(orderActionInfo);
            if (_ordernosql != null)
        ...
        public static List<OrderActionInfo> GetOrderActionList(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderActionList == null)
                {
                    ...
                    IDataReader reader = VMall.Core.BMAData.RDBS.GetOrderActionList(oid);
                    while (reader.Read())
                    {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}
