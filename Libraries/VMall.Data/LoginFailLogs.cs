...
namespace VMall.Data
{
    ...
    public partial class LoginFailLogs
    {
        ...
        public static LoginFailLogInfo GetLoginFailLogByIP(long loginIP)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetLoginFailLogByIP(loginIP);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.AddLoginFailTimes(loginIP, loginTime);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteLoginFailLogByIP(loginIP);
        }
    }
}
