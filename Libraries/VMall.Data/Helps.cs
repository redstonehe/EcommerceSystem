...
namespace VMall.Data
{
    ...
    public partial class Helps
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateHelp(helpInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteHelpById(id);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateHelp(helpInfo);
        }
        ...
        public static List<HelpInfo> GetHelpList()
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetHelpList();
        ...
        {
            return VMall.Core.BMAData.RDBS.UpdateHelpDisplayOrder(id, displayOrder);
        }
    }
}
