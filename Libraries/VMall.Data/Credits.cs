...
namespace VMall.Data
{
    ...
    public partial class Credits
    {
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCreditLogCount(condition);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.SendCredits(userRid, creditLogInfo);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetTodaySendPayCredits(uid, today);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetTodaySendRankCredits(uid, today);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsSendTodayLoginCredit(uid, today);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsSendCompleteUserInfoCredit(uid);
        }
        ...
        public static List<CreditLogInfo> GetPayCreditLogList(int uid, int type, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetPayCreditLogList(uid, type, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetPayCreditLogCount(uid, type);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetUserOrderSendCredits(oid);
        }
    }
}
