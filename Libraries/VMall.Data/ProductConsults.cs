...
namespace VMall.Data
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateProductConsultType(productConsultTypeInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProductConsultType(productConsultTypeInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteProductConsultTypeById(consultTypeId);
        }
        ...
        {
            DataTable dt = VMall.Core.BMAData.RDBS.GetProductConsultTypeList();
        ...
        {
            VMall.Core.BMAData.RDBS.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        public static ProductConsultInfo GetProductConsultById(int consultId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductConsultById(consultId);
            if (reader.Read())
            {
        ...
        {
            ProductConsultInfo productConsultInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetProductConsultById(consultId);
            if (reader.Read())
            {
                productConsultInfo = BuildProductConsultFromReader(reader);
            }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteProductConsultById(consultIdList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductConsultList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductConsultListCondition(consultTypeId, storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductConsultListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductConsultCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.UpdateProductConsultState(consultId, state);
        }
        ...
        public static List<ProductConsultInfo> GetProductConsultList(int pageSize, int pageNumber, int pid, int consultTypeId, string consultMessage)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        public static List<ProductConsultInfo> GetUserProductConsultList(int uid, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetUserProductConsultList(uid, pageSize, pageNumber);
            while (reader.Read())
            {
                ProductConsultInfo productConsultInfo = BuildProductConsultFromReader(reader);
                productConsultList.Add(productConsultInfo);
        ...
        {
            return VMall.Core.BMAData.RDBS.GetUserProductConsultCount(uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByConsultId(consultIdList);
        }
    }
}
