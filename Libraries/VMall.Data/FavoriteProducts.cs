...
namespace VMall.Data
{
    ...
    public partial class FavoriteProducts
    {
        ...
        {
            return VMall.Core.BMAData.RDBS.AddProductToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid, storeName, productName);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteProductCount(uid, storeName, productName);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteProductCount(uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.SetFavoriteProductState(uid, pid, state);
        }
    }
}
