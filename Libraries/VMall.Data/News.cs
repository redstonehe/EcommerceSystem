...
namespace VMall.Data
{
    ...
    public partial class News
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateNewsType(newsTypeInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteNewsTypeById(newsTypeId);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateNewsType(newsTypeInfo);
        }
        ...
        public static List<NewsTypeInfo> GetNewsTypeList()
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetNewsTypeList();
            while (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateNews(newsInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteNewsById(newsIdList);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateNews(newsInfo);
        }
        ...
        public static NewsInfo GetNewsById(int newsId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetNewsById(newsId);
            if (reader.Read())
            {
        ...
        {
            NewsInfo newsInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetNewsById(newsId);
            if (reader.Read())
            {
                newsInfo = BuildNewsFromReader(reader);
            }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetNewsList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetNewsListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetNewsCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetNewsIdByTitle(title);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetHomeNewsList(newsTypeId, count);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetNewsCount(condition);
        }
    }
}
