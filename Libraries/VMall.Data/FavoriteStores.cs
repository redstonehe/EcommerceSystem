...
namespace VMall.Data
{
    ...
    public partial class FavoriteStores
    {
        ...
        {
            return VMall.Core.BMAData.RDBS.AddStoreToFavorite(uid, storeId, addTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.DeleteFavoriteStoreByUidAndStoreId(uid, storeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistFavoriteStore(uid, storeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteStoreList(pageSize, pageNumber, uid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetFavoriteStoreCount(uid);
        }
    }
}
