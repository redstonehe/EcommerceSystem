...
namespace VMall.Data
{
    ...
    public partial class MallAdminLogs
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateMallAdminLog(mallAdminLogInfo);
        }
        ...
        public static List<MallAdminLogInfo> GetMallAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetMallAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetMallAdminLogCount(condition);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteMallAdminLogById(logIdList);
        }
