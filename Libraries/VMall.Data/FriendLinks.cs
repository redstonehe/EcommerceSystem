...
namespace VMall.Data
{
    ...
    public partial class FriendLinks
    {
        ...
        {
            DataTable dt = VMall.Core.BMAData.RDBS.GetFriendLinkList();
        ...
        {
            VMall.Core.BMAData.RDBS.CreateFriendLink(friendLinkInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteFriendLinkById(idList);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateFriendLink(friendLinkInfo);
        }
    }
}
