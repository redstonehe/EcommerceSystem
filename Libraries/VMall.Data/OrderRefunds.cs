...
namespace VMall.Data
{
    ...
    public partial class OrderRefunds
    {
        ...
        {
            VMall.Core.BMAData.RDBS.ApplyRefund(orderRefundInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.RefundOrder(refundId, refundSN, refundSystemName, refundFriendName, refundTime);
        }
        ...
        public static List<OrderRefundInfo> GetOrderRefundList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetOrderRefundList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        /// <returns></returns>
        public static string GetOrderRefundListCondition(int storeId, string osn,int state)
        {
            return VMall.Core.BMAData.RDBS.GetOrderRefundListCondition(storeId, osn,state);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetOrderRefundCount(condition);
        }
    }
}
