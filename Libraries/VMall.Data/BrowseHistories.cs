...
namespace VMall.Data
{
    ...
    public partial class BrowseHistories
    {
        ...
        public static List<PartProductInfo> GetUserBrowseProductList(int pageSize, int pageNumber, int uid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetUserBrowseProductList(pageSize, pageNumber, uid);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetUserBrowseProductCount(uid);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateBrowseHistory(uid, pid, updateTime);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.ClearExpiredBrowseHistory();
        }
    }
}
