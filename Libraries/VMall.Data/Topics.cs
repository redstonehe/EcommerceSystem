...
namespace VMall.Data
{
    ...
    public partial class Topics
    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateTopic(topicInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateTopic(topicInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteTopicById(topicId);
        }
        ...
        public static TopicInfo AdminGetTopicById(int topicId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetTopicById(topicId);
            if (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetTopicListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetTopicList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetTopicCount(condition);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistTopicSN(topicSN);
        }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.GetTopicByIdAndTime(topicId, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = VMall.Core.BMAData.RDBS.GetTopicBySNAndTime(topicSN, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
