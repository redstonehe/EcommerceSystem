...
namespace VMall.Data
{
    ...
    public partial class Products
    {
        ...
        public static ProductInfo BuildProductFromReader(IDataReader reader)
        {
            ...
            productInfo.PV = reader["pv"] is DBNull || string.IsNullOrEmpty(reader["pv"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["pv"]);
            productInfo.HaiMi = reader["haimi"] is DBNull || string.IsNullOrEmpty(reader["haimi"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["haimi"]);
            productInfo.SaleType = TypeHelper.ObjectToInt(reader["saletype"]);
            productInfo.TaxRate = TypeHelper.ObjectToDecimal(reader["taxrate"]);
            productInfo.HongBaoCut = TypeHelper.ObjectToDecimal(reader["hongbaocut"]);
            productInfo.ProductParam = reader["productparam"].ToString();
            productInfo.MobileDescription = reader["mobiledescription"].ToString();
            productInfo.MinBuyCount = TypeHelper.ObjectToInt(reader["minbuycount"]);
            productInfo.SubTitle = reader["subtitle"].ToString();
            productInfo.ShowOrder = TypeHelper.ObjectToInt(reader["showorder"]);
            productInfo.Unit = reader["unit"].ToString();

            productInfo.SettlePercent = TypeHelper.ObjectToInt(reader["settlepercent"]);
            productInfo.ReBuyCycle = TypeHelper.ObjectToInt(reader["rebuycycle"]);
            productInfo.RelateReBuyPid = TypeHelper.ObjectToInt(reader["relaterebuypid"]);
            productInfo.VideoUrl = reader["videourl"].ToString();
            return productInfo;
        }
        ...
        public static PartProductInfo BuildPartProductFromReader(IDataReader reader)
        {
            ...
            partProductInfo.PV = reader["pv"] is DBNull || string.IsNullOrEmpty(reader["pv"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["pv"]);
            partProductInfo.HaiMi = reader["haimi"] is DBNull || string.IsNullOrEmpty(reader["haimi"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["haimi"]);
            partProductInfo.SaleType = TypeHelper.ObjectToInt(reader["saletype"]);
            partProductInfo.TaxRate = TypeHelper.ObjectToDecimal(reader["taxrate"]);
            partProductInfo.HongBaoCut = TypeHelper.ObjectToDecimal(reader["hongbaocut"]);
            partProductInfo.MinBuyCount = TypeHelper.ObjectToInt(reader["minbuycount"]);
            partProductInfo.SubTitle = reader["subtitle"].ToString();
            partProductInfo.ShowOrder = TypeHelper.ObjectToInt(reader["showorder"]);
            partProductInfo.Unit = reader["unit"].ToString();

            partProductInfo.SettlePercent = TypeHelper.ObjectToInt(reader["settlepercent"]);
            partProductInfo.ReBuyCycle = TypeHelper.ObjectToInt(reader["rebuycycle"]);
            partProductInfo.RelateReBuyPid = TypeHelper.ObjectToInt(reader["relaterebuypid"]);
        ...
        public static StoreProductInfo BuildStoreProductFromReader(IDataReader reader)
        {
            ...
            storeProductInfo.PV = reader["pv"] is DBNull || string.IsNullOrEmpty(reader["pv"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["pv"]);
            storeProductInfo.HaiMi = reader["haimi"] is DBNull || string.IsNullOrEmpty(reader["haimi"].ToString()) ? 0M : TypeHelper.ObjectToDecimal(reader["haimi"]);
            storeProductInfo.SaleType = TypeHelper.ObjectToInt(reader["saletype"]);
            //storeProductInfo.TaxRate = TypeHelper.ObjectToFloat(reader["taxrate"]);
            storeProductInfo.MinBuyCount = TypeHelper.ObjectToInt(reader["minbuycount"]);
            storeProductInfo.StoreName = reader["storename"].ToString();
            storeProductInfo.HongBaoCut = TypeHelper.ObjectToDecimal(reader["hongbaocut"]);
        ...
        {
            int pid = VMall.Core.BMAData.RDBS.CreateProduct(productInfo);
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProduct(productInfo);
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteProductById(pidList);
            if (_productnosql != null)
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductListCondition(storeId, storeCid, productName, cateId, brandId, state,pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductCount(condition);
        }
        ...
        public static ProductInfo AdminGetProductById(int pid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetProductById(pid);
            if (reader.Read())
            {
        ...
        public static PartProductInfo AdminGetPartProductById(int pid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.AdminGetPartProductById(pid);
            if (reader.Read())
            {
        ...
        public static ProductInfo GetProductById(int pid)
        {
            ...
            {
                IDataReader reader = VMall.Core.BMAData.RDBS.GetProductById(pid);
                if (reader.Read())
                {
                    productInfo = BuildProductFromReader(reader);
                }
        ...
        public static PartProductInfo GetPartProductById(int pid)
        {
            ...
            {
                IDataReader reader = VMall.Core.BMAData.RDBS.GetPartProductById(pid);
                if (reader.Read())
                {
                    partProductInfo = BuildPartProductFromReader(reader);
                }
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateProductState(pidList, state);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateProductDisplayOrder(pid, displayOrder);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.ChangeProductIsNew(pidList, isNew);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.ChangeProductIsHot(pidList, isHot);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.ChangeProductIsBest(pidList, isBest);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateProductShopPrice(pid, shopPrice);
            if (_productnosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProductShowImage(pid, showImg);
            if (_productnosql != null)
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetProductIdByName(name);
        }
        ...
        public static List<PartProductInfo> GetPartProductList(string pidList)
        {
            ...
            else
            {
                ...
                IDataReader reader = VMall.Core.BMAData.RDBS.GetPartProductList(pidList);
                while (reader.Read())
                {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductShadowVisitCountById(pid);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProductShadowVisitCount(pid, visitCount);
            if (_productnosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.AddProductShadowSaleCount(pid, saleCount);
            if (_productnosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.AddProductShadowReviewCount(pid, starType);
            if (_productnosql != null)
        ...
        public static List<StoreProductInfo> GetCategoryProductList(int pageSize, int pageNumber, int cateId, int brandId, int filterPrice, string[] catePriceRangeList, List<int> attrValueIdList, int onlyStock, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetCategoryProductList(pageSize, pageNumber, cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock, sortColumn, sortDirection);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetCategoryProductCount(cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock);
        }
        ...
        public static List<PartProductInfo> GetStoreClassProductList(int pageSize, int pageNumber, int storeCid, int startPrice, int endPrice, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetStoreClassProductList(pageSize, pageNumber, storeCid, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreClassProductCount(storeCid, startPrice, endPrice);
        }
        ...
        public static List<PartProductInfo> GetStoreTraitProductList(int count, int storeId, int storeCid, int trait)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetStoreTraitProductList(count, storeId, storeCid, trait);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        public static List<PartProductInfo> GetStoreSaleProductList(int count, int storeId, int storeCid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetStoreSaleProductList(count, storeId, storeCid);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductSummaryList(pidList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetBrandProductCount(brandId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetCategoryProductCount(cateId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetAttrValueProductCount(attrValueId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByPid(pidList);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetStoreProductCount(storeId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetStoreClassProductCount(storeCid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetStoreShipTemplateProductCount(storeSTid);
        }
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.CreateProductAttribute(productAttributeInfo);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateProductAttribute(productAttributeInfo);
            if (_productnosql != null)
                _productnosql.ClearProductAttribute(productAttributeInfo.Pid);
            return result;
        }
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.DeleteProductAttributeByPidAndAttrId(pid, attrId);
            if (_productnosql != null)
        ...
        public static ProductAttributeInfo GetProductAttributeByPidAndAttrId(int pid, int attrId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductAttributeByPidAndAttrId(pid, attrId);
            if (reader.Read())
            {
        ...
        public static List<ProductAttributeInfo> GetProductAttributeList(int pid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductAttributeList(pid);
            while (reader.Read())
            {
        ...
        public static List<ExtProductAttributeInfo> GetExtProductAttributeList(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (extProductAttributeList == null)
                {
                    ...
                    IDataReader reader = VMall.Core.BMAData.RDBS.GetExtProductAttributeList(pid);
                    while (reader.Read())
                    {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateProductSKUItem(productSKUItemInfo);
            if (_productnosql != null)
        ...
        {
            return VMall.Core.BMAData.RDBS.GetProductSKUItemList(pid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistSKUGid(skuGid);
        }
        ...
        public static List<ExtProductSKUItemInfo> GetProductSKUListBySKUGid(int skuGid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (productSKUList == null)
                {
                    ...
                    IDataReader reader = VMall.Core.BMAData.RDBS.GetProductSKUListBySKUGid(skuGid);
                    while (reader.Read())
                    {
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.CreateProductImage(productImageInfo);
            if (_productnosql != null)
        ...
        public static ProductImageInfo GetProductImageById(int pImgId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductImageById(pImgId);
            if (reader.Read())
            {
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.DeleteProductImageById(pImgId);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.SetProductMainImage(pid, pImgId);
            if (_productnosql != null)
                _productnosql.ClearProductImage(pid);
            return result;
        }
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.ChangeProductImageDisplayOrder(pImgId, displayOrder);
            if (_productnosql != null)
                _productnosql.ClearProductImage(pid);
            return result;
        }
        ...
        public static List<ProductImageInfo> GetProductImageList(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (productImageList == null)
                {
                    ...
                    IDataReader reader = VMall.Core.BMAData.RDBS.GetProductImageList(pid);
                    while (reader.Read())
                    {
        ...
        public static ProductStockInfo GetProductStockByPid(int pid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductStockByPid(pid);
            if (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.CreateProductStock(pid, number, limit);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProductStock(pid, number, limit);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.UpdateProductStockNumber(pid, number);
            if (_productnosql != null)
                _productnosql.ClearProductStockNumber(pid);
            return result;
        }
        ...
        public static int GetProductStockNumberByPid(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                {
                    productStockNumber = VMall.Core.BMAData.RDBS.GetProductStockNumberByPid(pid);
        ...
        {
            VMall.Core.BMAData.RDBS.IncreaseProductStockNumber(orderProductList);
            if (_productnosql != null)
        ...
        {
            VMall.Core.BMAData.RDBS.DecreaseProductStockNumber(orderProductList);
            if (_productnosql != null)
        ...
        public static List<ProductStockInfo> GetProductStockList(string pidList)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductStockList(pidList);
            while (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.CreateProductKeyword(productKeywordInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateProductKeyword(productKeywordInfo);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.DeleteProductKeyword(keywordIdList);
        }
        ...
        public static List<ProductKeywordInfo> GetProductKeywordList(int pid)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetProductKeywordList(pid);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistProductKeyword(pid, keyword);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.UpdateProductKeywordRelevancy(keywordId, relevancy);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetPidByKeywordId(keywordId);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetStoreIdListByKeywordId(keywordIdList);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.AddRelateProduct(pid, relatePid);
            if (_productnosql != null)
        ...
        {
            bool result = VMall.Core.BMAData.RDBS.DeleteRelateProductByPidAndRelatePid(pid, relatePid);
            if (_productnosql != null)
                _productnosql.ClearRelatePidList(pid);
            return result;
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistRelateProduct(pid, relatePid);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.AdminGetRelateProductList(pid);
        }
        ...
        public static List<PartProductInfo> GetRelateProductList(int pid)
        {
            ...
            {
                partProductList = new List<PartProductInfo>();
                IDataReader reader = VMall.Core.BMAData.RDBS.GetRelateProductList(pid);
                while (reader.Read())
                {
                    PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                    partProductList.Add(partProductInfo);
        ...
        public static List<TimeProductInfo> GetTimeProductList(int type)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetTimeProductList(type);
            while (reader.Read())
            {
        ...
        {
            return VMall.Core.BMAData.RDBS.GetTimeProductList(pageSize, pageNumber, storeId, productName);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.GetTimeProductCount(storeId, productName);
        }
        ...
        public static TimeProductInfo GetTimeProductByRecordId(int recordId)
        {
            ...
            IDataReader reader = VMall.Core.BMAData.RDBS.GetTimeProductByRecordId(recordId);
            if (reader.Read())
            {
        ...
        {
            VMall.Core.BMAData.RDBS.AddTimeProduct(timeProductInfo);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.UpdateTimeProduct(timeProductInfo);
        }
        ...
        {
            return VMall.Core.BMAData.RDBS.IsExistTimeProduct(pid);
        }
        ...
        {
            VMall.Core.BMAData.RDBS.DeleteTimeProductByRecordId(recordId);
        }
        ...
        {
            List<StoreProductInfo> storeProductList = new List<StoreProductInfo>();
            IDataReader reader = VMall.Core.BMAData.RDBS.GetHomeProducts();
            while (reader.Read())
            {
                StoreProductInfo storeProductInfo = BuildStoreProductFromReader(reader);
                storeProductList.Add(storeProductInfo);
