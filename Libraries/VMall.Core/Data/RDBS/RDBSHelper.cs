...
namespace VMall.Core
{
    ...
    public partial class RDBSHelper
    {
        ...
        private static string _dirsaleconnectionstring;//直销系统数据库连接字符串
        ...
        /// 直销系统数据库连接字符串
        /// </summary>
        public static string DirSaleConnectionString
        {
            get { return _dirsaleconnectionstring; }
        }
        ...
        static RDBSHelper()
        {
            ...
            //设置直销系统数据库连接字符串
            _dirsaleconnectionstring = BMAConfig.RDBSConfig.DirSaleConnectString;
        }
