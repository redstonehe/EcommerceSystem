...
namespace VMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        string AdminGetProductListCondition(int storeId, int storeCid, string productName, int cateId, int brandId, int state,int pid=0);
        ...
        /// <returns></returns>
        string AdminGetProductReviewListCondition(int storeId, int pid,string pname,int type, string message, string startTime, string endTime);
