...
namespace VMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        DataTable AdminGetUserList(int pageSize, int pageNumber, string condition, string sort, string realName = "");
        ...
        /// <returns></returns>
        string AdminGetUserListCondition(string userName, string email, string mobile, int userRid, int mallAGid, int userType = -1);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        int AdminGetUserCount(string condition, string realName="");
        ...
        /// <returns></returns>
        bool UpdateUser(int uid, string userName, string nickName, string avatar, int gender, string realName, DateTime bday, string idCard, int regionId, string address, string bio, string bankName, string bankCardCode, string bankUserName);
