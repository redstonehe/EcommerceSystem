...
namespace VMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        IDataReader AdminGetBannerList(int pageSize, int pageNumber, string title, int type);

        /// <summary>
        /// 后台获得banner数量
        /// </summary>
        /// <returns></returns>
        int AdminGetBannerCount(string title, int type);
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        IDataReader GetAdvertPositionList(int pageSize, int pageNumber, string title);

        /// <summary>
        /// 获得广告位置数量
        /// </summary>
        /// <returns></returns>
        int GetAdvertPositionCount(string title);
        ...
        /// <param name="adPosId">广告位置id</param>
        /// <returns></returns>
        DataTable AdminGetAdvertList(int pageSize, int pageNumber, int adPosId, string title);
        ...
        /// <param name="adPosId">广告位置id</param>
        /// <returns></returns>
        int AdminGetAdvertCount(int adPosId, string title);
