...
namespace VMall.Core
{
    ...
    public partial class RDBSFields
    {
        ...
        /// 优惠劵表
        /// </summary>
        public const string COUPONS = "[couponid],[couponsn],[uid],[coupontypeid],[storeid],[oid],[usetime],[useip],[money],[activatetime],[activateip],[createuid],[createoid],[createtime],[createip],[validtime]";

        /// <summary>
        /// 优惠劵类型表
        /// </summary>
        public const string COUPON_TYPES = "[coupontypeid],[storeid],[state],[name],[money],[count],[sendmode],[getmode],[usemode],[userranklower],[orderamountlower],[limitstorecid],[limitproduct],[sendstarttime],[sendendtime],[useexpiretime],[usestarttime],[useendtime],[channelid]";
        ...
        /// 订单商品表
        /// </summary>
        public const string ORDER_PRODUCTS = "[recordid],[oid],[uid],[sid],[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[name],[showimg],[discountprice],[shopprice],[costprice],[marketprice],[weight],[isreview],[realcount],[buycount],[sendcount],[type],[paycredits],[coupontypeid],[extcode1],[extcode2],[extcode3],[extcode4],[extcode5],[addtime],[saletype]";
        ...
        /// 商品表
        /// </summary>
        public const string PRODUCTS = "[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[skugid],[name],[shopprice],[marketprice],[costprice],[state],[isbest],[ishot],[isnew],[displayorder],[weight],[showimg],[salecount],[visitcount],[reviewcount],[star1],[star2],[star3],[star4],[star5],[addtime],[description],[pv],[haimi],[saletype],[taxrate]";

        /// <summary>
        /// 商品部分表
        /// </summary>
        public const string PART_PRODUCTS = "[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[skugid],[name],[shopprice],[marketprice],[costprice],[state],[isbest],[ishot],[isnew],[displayorder],[weight],[showimg],[salecount],[visitcount],[reviewcount],[star1],[star2],[star3],[star4],[star5],[addtime],[pv],[haimi],[saletype],[taxrate]";
        ...
        /// 部分用户表
        /// </summary>
        public const string PARTUSERS = "[uid],[username],[email],[mobile],[password],[userrid],[storeid],[mallagid],[nickname],[avatar],[paycredits],[rankcredits],[verifyemail],[verifymobile],[liftbantime],[salt],[pid],[ptype]";
