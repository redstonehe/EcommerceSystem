...
namespace VMall.Core
{
    ...
    public partial interface IPromotionNOSQLStrategy
    {
        ...
        void ClearAllBuySendPromotion(int storeId);
        ...
        void AddAllBuySendPromotion(int storeId, List<BuySendPromotionInfo> buySendPromotionList);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        List<BuySendPromotionInfo> GetAllBuySendPromotion(int storeId);
        ...
        /// </summary>
        /// <param name="storeId">店铺id</param>
        void ClearAllFullCutPromotion(int storeId);

        /// <summary>
        /// 清空全部满减促销活动
        /// </summary>
        /// <param name="storeIdList">店铺id列表</param>
        void ClearAllFullCutPromotion(List<string> storeIdList);
        ...
        void AddAllFullCutPromotion(int storeId, List<FullCutPromotionInfo> fullCutPromotionList);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        List<FullCutPromotionInfo> GetAllFullCutPromotion(int storeId);
