...
namespace VMall.Core
{
    ...
    public class MallConfigInfo : IConfigInfo
    {
        ...
        {
            get { return _siteauthor; }
            set { _siteauthor = value; }
        }
        /// <summary>
        /// 脚本
        /// </summary>
        ...
        private decimal _HMtaxRate = 0m;//海米提现代扣费
        private decimal _HMfeeRate = 0m;//海米提现手续费
        private decimal _YJfeeRate = 0m;//佣金提现手续费
        private string _banklist = "";//银行列表
        /// <summary>
        ...
        /// 海米提现代扣费
        /// </summary>
        public decimal HMTaxRate
        {
            get { return _HMtaxRate; }
            set { _HMtaxRate = value; }
        }

        /// <summary>
        /// 海米提现手续费
        /// </summary>
        public decimal HMFeeRate
        {
            get { return _HMfeeRate; }
            set { _HMfeeRate = value; }
        }
        /// <summary>
        /// 佣金提现手续费
        /// </summary>
        public decimal YJFeeRate
        {
            get { return _YJfeeRate; }
            set { _YJfeeRate = value; }
        }
        ...
        private string _secretkey = string.Empty;//密钥 GUID ACC6D375-7D7F-4E4D-AB61-37DA9CA04765
