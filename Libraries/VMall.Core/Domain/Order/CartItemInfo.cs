...
namespace VMall.Core
{
    ...
    public class StoreCartInfo
    {
        ...
        private List<CartItemInfo> _cartitemlist;//购物车项列表
        private List<OrderProductInfo> _selectedorderproductlist;//选中的订单商品列表
        private List<OrderProductInfo> _remainedorderproductlist;//剩余的订单商品列表
        ...
        /// 购物车项列表
        /// </summary>
        public List<CartItemInfo>  CartItemList
        {
            get { return _cartitemlist; }
            set { _cartitemlist = value; }
        }
        /// <summary>
        /// 选中的订单商品列表
        /// </summary>
