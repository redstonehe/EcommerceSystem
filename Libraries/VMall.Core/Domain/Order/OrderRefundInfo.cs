...
namespace VMall.Core
{
    ...
    public class OrderRefundInfo
    {
        ...
        private string _refundtransn = string.Empty;//退款流水号
        private string _remark = string.Empty;//退款备注
        /// <summary>
        /// 退款id
        /// </summary>
        public int RefundId
        ...
        public string RefundSystemName
        {
            ...
            set { _refundsystemname = value.TrimEnd(); }
        }
        /// <summary>
        /// 退款方式昵称
        /// </summary>
        public string RefundFriendName
        {
            ...
            set { _refundfriendname = value.TrimEnd(); }
        }
        /// <summary>
        /// 退款时间
        /// </summary>
        ...
        /// /退款流水号
        /// </summary>
        public string RefundTranSN
        {
            get { return _refundtransn; }
            set { _refundtransn = value.TrimEnd(); }
        }
        /// <summary>
        /// 退款备注
        /// </summary>
