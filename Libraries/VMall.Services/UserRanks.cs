...
namespace VMall.Services
{
    ...
    public partial class UserRanks
    {
        ...
        {
            List<UserRankInfo> userRankList = VMall.Core.BMACache.Get(CacheKeys.MALL_USERRANK_LIST) as List<UserRankInfo>;
            if (userRankList == null)
            {
                userRankList = VMall.Data.UserRanks.GetUserRankList();
                VMall.Core.BMACache.Insert(CacheKeys.MALL_USERRANK_LIST, userRankList);
            }
            return userRankList;
        }
