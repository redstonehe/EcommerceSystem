...
namespace VMall.Services
{
    ...
    public partial class ProductReviews
    {
        ...
        {
            return VMall.Data.ProductReviews.GetProductReviewById(reviewId);
        }
        ...
        {
            VMall.Data.ProductReviews.ReviewProduct(productReviewInfo);
        }
        ...
        {
            VMall.Data.ProductReviews.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return VMall.Data.ProductReviews.IsVoteProductReview(reviewId, uid);
        }
        ...
        public static bool ChangeProductReviewState(int reviewId, int state)
        {
            if (reviewId > 0 && (state == 0 || state == 1))
                return VMall.Data.ProductReviews.ChangeProductReviewState(reviewId, state);
            return false;
        }
        ...
        {
            return VMall.Data.ProductReviews.GetUserProductReviewList(uid, pageSize, pageNumber);
        }
        ...
        {
            return VMall.Data.ProductReviews.GetUserProductReviewCount(uid);
        }
        ...
        {
            return VMall.Data.ProductReviews.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return VMall.Data.ProductReviews.GetProductReviewCount(pid, type);
        }
        ...
        {
            return VMall.Data.ProductReviews.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return VMall.Data.ProductReviews.GetProductReviewList(startTime, endTime);
        }
    }
}
