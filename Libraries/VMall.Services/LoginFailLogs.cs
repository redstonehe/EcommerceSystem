...
namespace VMall.Services
{
    ...
    public partial class LoginFailLogs
    {
        ...
        {
            LoginFailLogInfo loginFailLogInfo = VMall.Data.LoginFailLogs.GetLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        ...
        {
            VMall.Data.LoginFailLogs.AddLoginFailTimes(CommonHelper.ConvertIPToLong(loginIP), loginTime);
        }
        ...
        {
            VMall.Data.LoginFailLogs.DeleteLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        }
    }
}
