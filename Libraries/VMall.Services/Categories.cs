...
namespace VMall.Services
{
    ...
    public partial class Categories
    {
        ...
        {
            List<CategoryInfo> categoryList = VMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_LIST) as List<CategoryInfo>;
            if (categoryList == null)
            {
                categoryList = new List<CategoryInfo>();
                List<CategoryInfo> sourceCategoryList = VMall.Data.Categories.GetCategoryList();
                CreateCategoryTree(sourceCategoryList, categoryList, 0);
                VMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_LIST, categoryList);
            }
            return categoryList;
        }
        ...
        {
            List<BrandInfo> brandList = VMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId) as List<BrandInfo>;
            if (brandList == null)
            {
                brandList = VMall.Data.Categories.GetCategoryBrandList(cateId);
                if (brandList != null)
                    VMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId, brandList);
            }
        ...
        {
            List<KeyValuePair<AttributeInfo, List<AttributeValueInfo>>> itemList = VMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId) as List<KeyValuePair<AttributeInfo, List<AttributeValueInfo>>>;
            if (itemList == null)
            {
                ...
                VMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId, itemList);
            }
        ...
        {
            string jsonCache = VMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId) as string;
            if (jsonCache == null)
            {
                ...
                VMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId, jsonCache);
            }
        ...
        {
            return VMall.Data.Categories.GetAttributeGroupListByCateId(cateId);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeGroupById(attrGroupId);
        }
        ...
        public static int GetAttributeGroupIdByCateIdAndName(int cateId, string name)
        {
            if (cateId < 1 || string.IsNullOrWhiteSpace(name))
                return 0;
            return VMall.Data.Categories.GetAttrGroupIdByCateIdAndName(cateId, name);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeById(attrId);
        }
        ...
        public static int GetAttrIdByCateIdAndName(int cateId, string attributeName)
        {
            if (cateId < 1 || string.IsNullOrWhiteSpace(attributeName))
                return 0;
            return VMall.Data.Categories.GetAttrIdByCateIdAndName(cateId, attributeName);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeListByCateId(cateId);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeListByAttrGroupId(attrGroupId);
        }
        ...
        {
            return VMall.Data.Categories.GetFilterAttributeListByCateId(cateId);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeValueListByAttrId(attrId);
        }
        ...
        {
            return VMall.Data.Categories.GetAttributeValueById(attrValueId);
        }
        ...
        public static int GetAttributeValueIdByAttrIdAndValue(int attrId, string attrValue)
        {
            if (attrId < 1 || string.IsNullOrWhiteSpace(attrValue))
                return 0;
            return VMall.Data.Categories.GetAttributeValueIdByAttrIdAndValue(attrId, attrValue);
        }
    }
}
