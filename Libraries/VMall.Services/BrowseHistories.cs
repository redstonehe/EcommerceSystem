    ...
    public partial class BrowseHistories
    {
        ...
        public static List<PartProductInfo> GetUserBrowseHistory(int uid, int pid)
        {
            ...
            if (broHisCount > 0)
            {
                ...
                HttpCookie cookie = HttpContext.Current.Request.Cookies["viewhistory"];
                if (cookie != null)
                {
                ...
                {
                    partProductList = new List<PartProductInfo>();
                    cookie = new HttpCookie("viewhistory");
                    if (uid > 0)
                    {
        ...
        {
            return VMall.Data.BrowseHistories.GetUserBrowseProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return VMall.Data.BrowseHistories.GetUserBrowseProductCount(uid);
        }
        ...
        public static void UpdateBrowseHistory(object state)
        {
            ...
            VMall.Data.BrowseHistories.UpdateBrowseHistory(updateBrowseHistoryState.Uid, updateBrowseHistoryState.Pid, updateBrowseHistoryState.UpdateTime);
        }
        ...
        {
            VMall.Data.BrowseHistories.ClearExpiredBrowseHistory();
        }
    }
}
