...
namespace VMall.Services
{
    ...
    public partial class Credits
    {
        ...
        {
            VMall.Data.Credits.SendCredits(userRid, creditLogInfo);
        }
        ...
        {
            return VMall.Data.Credits.GetPayCreditLogList(uid, type, pageSize, pageNumber);
        }
        ...
        {
            return VMall.Data.Credits.GetPayCreditLogCount(uid, type);
        }
        ...
        {
            return VMall.Data.Credits.GetTodaySendPayCredits(uid, today);
        }
        ...
        {
            return VMall.Data.Credits.GetTodaySendRankCredits(uid, today);
        }
        ...
        {
            return VMall.Data.Credits.IsSendTodayLoginCredit(uid, today);
        }
        ...
        {
            return VMall.Data.Credits.IsSendCompleteUserInfoCredit(uid);
        }
        ...
        {
            return VMall.Data.Credits.GetUserOrderSendCredits(oid);
        }
    }
}
