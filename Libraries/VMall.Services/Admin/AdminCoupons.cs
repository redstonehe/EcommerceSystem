...
namespace VMall.Services
{
    ...
    public partial class AdminCoupons : Coupons
    {
        ...
        {
            VMall.Data.Coupons.CreateCouponType(couponTypeInfo);
        }
        ...
        public static void DeleteCouponTypeById(int[] couponTypeIdList)
        {
            ...
            {
                //删除优惠劵类型
                VMall.Data.Coupons.DeleteCouponTypeById(CommonHelper.IntArrayToString(couponTypeIdList));

                //删除优惠劵类型缓存
                foreach (int couponTypeId in couponTypeIdList)
                {
                    VMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
                    VMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId);
                }
            }
        }
        ...
        public static CouponTypeInfo AdminGetCouponTypeById(int couponTypeId)
        {
            ...
            return VMall.Data.Coupons.AdminGetCouponTypeById(couponTypeId);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            bool result = VMall.Data.Coupons.ChangeCouponTypeState(couponTypeId, state);
            if (result)
            {
                VMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
                VMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId);
        ...
        {
            if (couponTypeIdList != null && couponTypeIdList.Length > 0)
                return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(CommonHelper.IntArrayToString(couponTypeIdList));
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponCount(condition);
        }
        ...
        public static void AdminSendCouponToUser(int uid, int couponTypeId, int storeId, int money, int count, int sendUid, DateTime sendTime, string sendIP, int UseExpireTime, DateTime UseStartTime, DateTime UseEndTime,string ChannelId)
        {
            for (int i = 0; i < count; i++)
            {
                ...
                couponInfo.ActivateTime = UseStartTime > DateTime.Now ? UseStartTime : DateTime.Now;
                ...
                couponInfo.ValidTime = UseExpireTime > 0 ? DateTime.Now.AddDays(UseExpireTime) : UseEndTime;
                couponInfo.ChannelId = ChannelId;
        ...
        public static DataTable GetStoreIdListByCouponId(int[] couponIdList)
        {
            if (couponIdList != null && couponIdList.Length > 0)
                return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponId(CommonHelper.IntArrayToString(couponIdList));
            return new DataTable();
        }
        ...
        public static void AddCouponProduct(int couponTypeId, int pid)
        {
            if (couponTypeId > 0 && pid > 0)
                VMall.Data.Coupons.AddCouponProduct(couponTypeId, pid);
        }
        ...
        public static bool DeleteCouponProductByRecordId(int[] recordIdList)
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return VMall.Data.Coupons.DeleteCouponProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return VMall.Data.Coupons.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return VMall.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
