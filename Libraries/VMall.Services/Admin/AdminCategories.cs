...
namespace VMall.Services
{
    ...
    public partial class AdminCategories : Categories
    {
        ...
        public static void UpdateCategory(CategoryInfo categoryInfo, int oldParentId)
        {
            ...
            {
                int changeLayer = 0;
                List<CategoryInfo> categoryList = VMall.Data.Categories.GetCategoryList();
                ...
                if (categoryInfo.ParentId > 0)//非顶层分类时
                {
                    ...
                    if (newParentCategoryInfo.HasChild == 0)
                    {
                        ...
                        VMall.Data.Categories.UpdateCategory(newParentCategoryInfo);
                    }
                }
                else//顶层分类时
                {
                ...
                if (oldParentId > 0 && categoryList.FindAll(x => x.ParentId == oldParentId).Count == 1)
                {
                    ...
                    VMall.Data.Categories.UpdateCategory(oldParentCategoryInfo);
                }
            ...
            VMall.Data.Categories.UpdateCategory(categoryInfo);

            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
        ...
        public static void CreateCategory(CategoryInfo categoryInfo)
        {
            if (categoryInfo.ParentId > 0)
            {
                ...
                categoryInfo.Path = "";
                int categoryId = VMall.Data.Categories.CreateCategory(categoryInfo);
                ...
                if (parentCategoryInfo.HasChild == 0)
                {
                    ...
                    VMall.Data.Categories.UpdateCategory(parentCategoryInfo);
                }
            }
            else
            {
        ...
        public static int DeleteCategoryById(int cateId)
        {
            ...
            VMall.Data.Categories.DeleteCategoryById(cateId);
            ...
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId);
        ...
        {
            VMall.Data.Categories.UpdateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            VMall.Data.Categories.CreateAttributeGroup(attributeGroupInfo);
        }
        ...
        public static int DeleteAttributeGroupById(int attrGroupId)
        {
            if (GetAttributeListByAttrGroupId(attrGroupId).Count > 0)
                return 0;
            VMall.Data.Categories.DeleteAttributeGroupById(attrGroupId);
            return 1;
        }
        ...
        {
            VMall.Data.Categories.UpdateAttribute(attributeInfo);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + attributeInfo.CateId);
        }
        ...
        {
            VMall.Data.Categories.CreateAttribute(attributeInfo, attributeGroupInfo.AttrGroupId, attributeGroupInfo.Name, attributeGroupInfo.DisplayOrder);
            //VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + attributeInfo.CateId);
        }
        ...
        public static int DeleteAttributeById(int attrId)
        {
            ...
            VMall.Data.Categories.DeleteAttributeById(attrId);
        ...
        {
            return VMall.Data.Categories.AdminGetAttributeList(cateId, sort);
        }
        ...
        {
            return VMall.Data.Categories.AdminGetAttributeListSort(sortColumn, sortDirection);
        }
        ...
        {
            VMall.Data.Categories.CreateAttributeValue(attributeValueInfo);
        ...
        public static int DeleteAttributeValueById(int attrValueId)
        {
            ...
            if (AdminProducts.AdminGetAttrValueProductCount(attrValueId) > 0)
                return 0;
            AttributeInfo attributeInfo = GetAttributeById(attributeValueInfo.AttrId);
            VMall.Data.Categories.DeleteAttributeValueById(attrValueId);
            if (attributeInfo.IsFilter == 1)
            {
                VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            }
        ...
        {
            VMall.Data.Categories.UpdateAttributeValue(attributeValueInfo);
            AttributeInfo attributeInfo = GetAttributeById(attributeValueInfo.AttrId);
            if (attributeInfo.IsFilter == 1)
            {
                VMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
