...
namespace VMall.Services
{
    ...
    public partial class AdminCredits : Credits
    {
        ...
        {
            return VMall.Data.Credits.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Data.Credits.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return VMall.Data.Credits.AdminGetCreditLogCount(condition);
        }
