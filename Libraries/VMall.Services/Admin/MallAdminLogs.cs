...
namespace VMall.Services
{
    ...
    public partial class MallAdminLogs
    {
        ...
        public static void CreateMallAdminLog(int uid, string nickName, int mallAGid, string mallAGTitle, string ip, string operation, string description)
        {
            ...
            VMall.Data.MallAdminLogs.CreateMallAdminLog(adminOperateLogInfo);
        }
        ...
        {
            return VMall.Data.MallAdminLogs.GetMallAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Data.MallAdminLogs.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return VMall.Data.MallAdminLogs.GetMallAdminLogCount(condition);
        }
        ...
        public static void DeleteMallAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                VMall.Data.MallAdminLogs.DeleteMallAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
