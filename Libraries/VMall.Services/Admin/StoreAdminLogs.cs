...
namespace VMall.Services
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        public static void CreateStoreAdminLog(int uid, string nickName, int storeId, string storeName, string ip, string operation, string description)
        {
            ...
            VMall.Data.StoreAdminLogs.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        {
            return VMall.Data.StoreAdminLogs.GetStoreAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return VMall.Data.StoreAdminLogs.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return VMall.Data.StoreAdminLogs.GetStoreAdminLogCount(condition);
        }
        ...
        public static void DeleteStoreAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                VMall.Data.StoreAdminLogs.DeleteStoreAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
