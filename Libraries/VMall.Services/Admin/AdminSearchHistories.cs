...
namespace VMall.Services
{
    public partial class AdminSearchHistories : SearchHistories
    {
        ...
        {
            return VMall.Data.SearchHistories.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return VMall.Data.SearchHistories.GetSearchWordStatListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Data.SearchHistories.GetSearchWordStatCount(word);
        }
    }
}
