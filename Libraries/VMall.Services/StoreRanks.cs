...
namespace VMall.Services
{
    ...
    public partial class StoreRanks
    {
        ...
        {
            List<StoreRankInfo> storeRankList = VMall.Core.BMACache.Get(CacheKeys.MALL_STORE_RANKLIST) as List<StoreRankInfo>;
            if (storeRankList == null)
            {
                storeRankList = VMall.Data.StoreRanks.GetStoreRankList();
                VMall.Core.BMACache.Insert(CacheKeys.MALL_STORE_RANKLIST, storeRankList);
            }
