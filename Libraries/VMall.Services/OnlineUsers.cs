...
namespace VMall.Services
{
    ...
    public partial class OnlineUsers
    {
        ...
        public static int CreateOnlineMember(int uid, string sid, string nickName, DateTime updateTime, string ip, int regionId)
        {
            ...
            int olid = VMall.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        ...
        public static int CreateOnlineGuest(string sid, DateTime updateTime, string ip, int regionId)
        {
            ...
            return VMall.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            VMall.Data.OnlineUsers.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            VMall.Data.OnlineUsers.UpdateOnlineUserUid(olId, uid);
        }
        ...
        {
            return VMall.Data.OnlineUsers.GetOnlineUserBySid(sid);
        }
        ...
        {
            return VMall.Data.OnlineUsers.GetOnlineUserCount(userType);
        }
        ...
        public static int GetOnlineUserCount()
        {
            ...
            int onlineAllUserCount = TypeHelper.ObjectToInt(VMall.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT), -1);
            if (onlineAllUserCount == -1)
            {
                onlineAllUserCount = GetOnlineUserCount(0);
                VMall.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT, onlineAllUserCount);
            }
        ...
        public static int GetOnlineGuestCount()
        {
            ...
            int onlineGuestCount = TypeHelper.ObjectToInt(VMall.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT), -1);
            if (onlineGuestCount == -1)
            {
                onlineGuestCount = GetOnlineUserCount(-1);
                VMall.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT, onlineGuestCount);
            }
        ...
        {
            VMall.Data.OnlineUsers.DeleteOnlineUserBySid(sid);
        }
        ...
        public static void DeleteExpiredOnlineUser()
        {
            ...
            {
                VMall.Data.OnlineUsers.DeleteExpiredOnlineUser(BMAConfig.MallConfig.OnlineUserExpire);
        ...
        public static void ResetOnlineUserTable()
        {
            try
            {
                VMall.Data.OnlineUsers.ResetOnlineUserTable();
            }
            catch
            {
                try
        ...
        {
            return VMall.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId, sort);
        }
        ...
        {
            return VMall.Data.OnlineUsers.GetOnlineUserListSort(sortColumn, sortDirection);
        }
        ...
        {
            return VMall.Data.OnlineUsers.GetOnlineUserCount(locationType, locationId);
        }
    }
}
