...
namespace VMall.Services
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            ProductConsultTypeInfo[] productConsultTypeList = VMall.Core.BMACache.Get(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST) as ProductConsultTypeInfo[];
            if (productConsultTypeList == null)
            {
                productConsultTypeList = VMall.Data.ProductConsults.GetProductConsultTypeList();
                VMall.Core.BMACache.Insert(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST, productConsultTypeList);
            }
        ...
        {
            VMall.Data.ProductConsults.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            VMall.Data.ProductConsults.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        {
            if (consultId > 0)
                return VMall.Data.ProductConsults.GetProductConsultById(consultId);
            return null;
        }
        ...
        public static void DeleteProductConsultById(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                VMall.Data.ProductConsults.DeleteProductConsultById(CommonHelper.IntArrayToString(consultIdList));
        }
        ...
        public static bool UpdateProductConsultState(int consultId, int state)
        {
            if (consultId > 0 && (state == 0 || state == 1))
                return VMall.Data.ProductConsults.UpdateProductConsultState(consultId, state);
            return false;
        }
        ...
        {
            return VMall.Data.ProductConsults.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
        }
        ...
        {
            return VMall.Data.ProductConsults.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        {
            return VMall.Data.ProductConsults.GetUserProductConsultList(uid, pageSize, pageNumber);
        }
        ...
        {
            return VMall.Data.ProductConsults.GetUserProductConsultCount(uid);
        }
    }
}
