...
namespace VMall.Services
{
    ...
    public partial class PVStats
    {
        ...
        {
            VMall.Data.PVStats.UpdatePVStat((UpdatePVStatState)updatePVStatState);
        }
        ...
        {
            return VMall.Data.PVStats.GetProvinceRegionStat();
        }
        ...
        {
            return VMall.Data.PVStats.GetCityRegionStat(provinceId);
        }
        ...
        {
            return VMall.Data.PVStats.GetCountyRegionStat(cityId);
        }
        ...
        {
            return VMall.Data.PVStats.GetPVStatList(condition);
        }
        ...
        {
            return VMall.Data.PVStats.GetPVStatByCategoryAndValue(category, value);
        }
