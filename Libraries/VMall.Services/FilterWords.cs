...
namespace VMall.Services
{
    ...
    public partial class FilterWords
    {
        ...
        {
            return VMall.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = VMall.Core.BMACache.Get(CacheKeys.MALL_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                VMall.Core.BMACache.Insert(CacheKeys.MALL_FILTERWORD_REGEXLIST, filterWordRegexList);
            }
