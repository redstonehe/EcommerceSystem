...
namespace VMall.RDBSStrategy.SqlServer
{
    ...
    public partial class RDBSStrategy : IRDBSStrategy
    {
        ...
        public int CreateUser(UserInfo userInfo)
        {
            DbParameter[] parms = {
									   ...
									   GenerateInParam("@avatar",SqlDbType.VarChar,200,userInfo.Avatar),
                                       ...
                                       GenerateInParam("@pid",SqlDbType.Int,6,userInfo.Pid),
                                       GenerateInParam("@ptype",SqlDbType.TinyInt,4,userInfo.Ptype),
                                       GenerateInParam("@isdirsaleuser",SqlDbType.TinyInt,1,userInfo.IsDirSaleUser?1:0),
                                       GenerateInParam("@dirsaleuid",SqlDbType.Int,6,userInfo.DirSaleUid),
                                       GenerateInParam("@isfxuser",SqlDbType.TinyInt,1,userInfo.IsFXUser),
                                       GenerateInParam("@dirsalepwd",SqlDbType.VarChar,100,userInfo.DirSalePwd),
                                       GenerateInParam("@maxcashcount",SqlDbType.Int,6,userInfo.MaxCashCount),
                                       GenerateInParam("@agenttype",SqlDbType.TinyInt,1,userInfo.AgentType),
                                       GenerateInParam("@ds2agentrank",SqlDbType.TinyInt,1,userInfo.Ds2AgentRank),
                                       GenerateInParam("@usersource",SqlDbType.TinyInt,1,userInfo.UserSource),
                                       ...
                                       GenerateInParam("@bankname",SqlDbType.NVarChar,50,userInfo.BankName),
                                       GenerateInParam("@bankcardcode",SqlDbType.VarChar,300,userInfo.BankCardCode),
                                       GenerateInParam("@bankusername",SqlDbType.NVarChar,30,userInfo.BankUserName)
								   };
        ...
        public void UpdateUser(UserInfo userInfo)
        {
            DbParameter[] parms = {
									   ...
									   GenerateInParam("@liftbantime",SqlDbType.DateTime,8,userInfo.LiftBanTime),
                                       GenerateInParam("@salt",SqlDbType.NChar,6,userInfo.Salt),
                                       GenerateInParam("@dirsalepwd",SqlDbType.Char,32,userInfo.DirSalePwd),
                                       GenerateInParam("@lastvisittime",SqlDbType.DateTime,8,userInfo.LastVisitTime),
                                       GenerateInParam("@lastvisitip",SqlDbType.Char,15,userInfo.LastVisitIP),
                                       GenerateInParam("@lastvisitrgid",SqlDbType.SmallInt,2,userInfo.LastVisitRgId),
									   GenerateInParam("@registertime",SqlDbType.DateTime,8,userInfo.RegisterTime),
									   ...
									   GenerateInParam("@bio",SqlDbType.NVarChar,300,userInfo.Bio),
                                       GenerateInParam("@bankname",SqlDbType.NVarChar,50,userInfo.BankName),
                                       GenerateInParam("@bankcardcode",SqlDbType.VarChar,30,userInfo.BankCardCode),
                                       GenerateInParam("@bankusername",SqlDbType.NVarChar,30,userInfo.BankUserName),
									   GenerateInParam("@uid",SqlDbType.Int,4,userInfo.Uid),
                                       GenerateInParam("@isbusinesscentre",SqlDbType.Bit,1,0),
                                       GenerateInParam("@isinternaluser",SqlDbType.Bit,1,0)
								   };
        ...
        public void UpdatePartUser(PartUserInfo partUserInfo)
        {
            DbParameter[] parms = {
									   ...
									   GenerateInParam("@avatar",SqlDbType.VarChar,200,partUserInfo.Avatar),
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public DataTable AdminGetUserList(int pageSize, int pageNumber, string condition, string sort, string realName = "")
        {
            bool noCondition = string.IsNullOrWhiteSpace(condition);
            string strWhere = " 1=1 ";
 ...
 select * from tb where RowNumber between (" + pageNumber + @"-1)*" + pageSize + @"+1 and (" + pageNumber + @")*" + pageSize + " order by tb.[uid] desc", noCondition ? "" : " AND " + condition, strWhere);
            ...
            //{
            //    if (noCondition)
            //        commandText = string.Format("SELECT TOP {0} [{1}users].*,[{1}userdetails].[lastvisittime],[{1}userdetails].[lastvisitip],[{1}userdetails].[registertime],[{1}userdetails].[gender],[{1}userdetails].[realname],[{1}userranks].[title] AS [utitle],[{1}malladmingroups].[title] AS [atitle] FROM [{1}users] LEFT JOIN [{1}userdetails] ON [{1}userdetails].[uid] = [{1}users].[uid]  LEFT JOIN [{1}userranks] ON [{1}userranks].[userrid]=[{1}users].[userrid]  LEFT JOIN [{1}malladmingroups] ON [{1}malladmingroups].[mallagid]=[{1}users].[mallagid] ORDER BY {2}",
            //                                    pageSize,
            //                                    RDBSHelper.RDBSTablePre,
            //                                    sort );

            //    else
            //        commandText = string.Format("SELECT TOP {0} [{1}users].*,[{1}userdetails].[lastvisittime],[{1}userdetails].[lastvisitip],[{1}userdetails].[registertime],[{1}userdetails].[gender],[{1}userdetails].[realname],[{1}userranks].[title] AS [utitle],[{1}malladmingroups].[title] AS [atitle] FROM [{1}users] LEFT JOIN [{1}userdetails] ON [{1}userdetails].[uid] = [{1}users].[uid]  LEFT JOIN [{1}userranks] ON [{1}userranks].[userrid]=[{1}users].[userrid]  LEFT JOIN [{1}malladmingroups] ON [{1}malladmingroups].[mallagid]=[{1}users].[mallagid] WHERE {2} AND {4} ORDER BY {3}",
            //                                    pageSize,
            //                                    RDBSHelper.RDBSTablePre,
            //                                    condition,
            //                                    sort,
            ...
            //{
            //    if (noCondition)
            //        commandText = string.Format("SELECT TOP {0} [{1}users].*,[{1}userdetails].[lastvisittime],[{1}userdetails].[lastvisitip],[{1}userdetails].[registertime],[{1}userdetails].[gender],[{1}userdetails].[realname],[{1}userranks].[title] AS [utitle],[{1}malladmingroups].[title] AS [atitle] FROM [{1}users],[{1}userdetails],[{1}userranks],[{1}malladmingroups]  WHERE [{1}userdetails].[uid] = [{1}users].[uid] AND  [{1}userranks].[userrid]=[{1}users].[userrid] AND  [{1}malladmingroups].[mallagid]=[{1}users].[mallagid] AND [{1}users].[uid] < (SELECT min([uid])  FROM (SELECT TOP {2} [{1}users].[uid] FROM [{1}users]  left join [{1}userdetails]  on [{1}userdetails].[uid] = [{1}users].[uid] where {4}  ORDER BY {3}) AS temp )  ORDER BY {3}",
            //                                    pageSize,
            //                                    RDBSHelper.RDBSTablePre,
            //                                    (pageNumber - 1) * pageSize,
            //                                    sort,
            //                                    strWhere);
            //    else
            //        commandText = string.Format("SELECT TOP {0} [{1}users].*,[{1}userdetails].[lastvisittime],[{1}userdetails].[lastvisitip],[{1}userdetails].[registertime],[{1}userdetails].[gender],[{1}userdetails].[realname],[{1}userranks].[title] AS [utitle],[{1}malladmingroups].[title] AS [atitle] FROM [{1}users],[{1}userdetails],[{1}userranks],[{1}malladmingroups]  WHERE [{1}userdetails].[uid] = [{1}users].[uid] AND  [{1}userranks].[userrid]=[{1}users].[userrid] AND  [{1}malladmingroups].[mallagid]=[{1}users].[mallagid] AND [{1}users].[uid] < (SELECT min([uid])  FROM (SELECT TOP {2} [{1}users].[uid] FROM [{1}users] left join [{1}userdetails]  on [{1}userdetails].[uid] = [{1}users].[uid] WHERE {4} AND {5} ORDER BY {3}) AS temp )   ORDER BY {3}",
            //                                    pageSize,
            //                                    RDBSHelper.RDBSTablePre,
            //                                    (pageNumber - 1) * pageSize,
            //                                    sort,
        ...
        /// <returns></returns>
        public string AdminGetUserListCondition(string userName, string email, string mobile, int userRid, int mallAGid, int userType = -1)
        {
            StringBuilder condition = new StringBuilder();

            if (!string.IsNullOrWhiteSpace(userName))
                condition.AppendFormat(" AND a.[username] like '%{0}%' OR a.[email] like '%{0}%' OR a.[mobile] like '%{0}%' ", userName, RDBSHelper.RDBSTablePre);

            if (!string.IsNullOrWhiteSpace(email))
                condition.AppendFormat(" AND a.[email] like '%{0}%' ", email, RDBSHelper.RDBSTablePre);

            if (!string.IsNullOrWhiteSpace(mobile))
                condition.AppendFormat(" AND a.[mobile] like '%{0}%' ", mobile, RDBSHelper.RDBSTablePre);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        public int AdminGetUserCount(string condition, string realName = "")
        {
            string commandText;
            if (string.IsNullOrWhiteSpace(condition))
                if (!string.IsNullOrEmpty(realName))
                    commandText = string.Format("SELECT COUNT(a.[uid]) FROM [{0}users] a LEFT JOIN [{0}userdetails] b ON a.[uid]=b.[uid] WHERE b.[realname] like '%{1}%'", RDBSHelper.RDBSTablePre, realName);
                else
                    commandText = string.Format("SELECT COUNT(a.[uid]) FROM [{0}users] a", RDBSHelper.RDBSTablePre);
            else
                if (!string.IsNullOrEmpty(realName))
                    commandText = string.Format("SELECT COUNT(a.[uid]) FROM [{0}users] a LEFT JOIN [{0}userdetails] b ON a.[uid]=b.[uid] WHERE {1} AND b.[realname] like '%{2}%'", RDBSHelper.RDBSTablePre, condition, realName);
                else

                    commandText = string.Format("SELECT COUNT(a.[uid]) FROM [{0}users] a WHERE {1}", RDBSHelper.RDBSTablePre, condition);
        ...
        /// <returns></returns>
        public bool UpdateUser(int uid, string userName, string nickName, string avatar, int gender, string realName, DateTime bday, string idCard, int regionId, string address, string bio, string bankName, string bankCardCode, string bankUserName)
        {
            DbParameter[] parms = {
									   GenerateInParam("@username",SqlDbType.NChar,20,userName),
									   GenerateInParam("@nickname",SqlDbType.NChar,20,nickName),
									   GenerateInParam("@avatar",SqlDbType.VarChar,200,avatar),
                                       ...
                                       GenerateInParam("@bankname",SqlDbType.NVarChar,50,bankName),
                                       GenerateInParam("@bankcardcode",SqlDbType.VarChar,30,bankCardCode),
                                       GenerateInParam("@bankusername",SqlDbType.NVarChar,30,bankUserName),
									   GenerateInParam("@uid",SqlDbType.Int,4,uid),
								   };
        ...
        public void SetStoreAdminer(int uid, int storeId)
        {
            ...
            string commandText = string.Format("UPDATE [{0}users] SET [storeid]=@storeid WHERE [uid]=@uid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
