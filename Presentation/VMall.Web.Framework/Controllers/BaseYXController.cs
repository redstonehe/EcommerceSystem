...
namespace VMall.Web.Framework
{
    ...
    /// 移动前台基础控制器类
    /// </summary>
    public class BaseYXController : Controller
    {
        //工作上下文
        public YXWorkContext WorkContext = new YXWorkContext();
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            {
                filterContext.HttpContext.Response.Redirect("/youxuan/error.html");
                //filterContext.HttpContext.Response.Redirect("/YX");
                //filterContext.Result = new ViewResult() { ViewName = "error" };
                ...
                //filterContext.HttpContext.Response.Redirect("/YX/error.html");
                //filterContext.Result = View("~/YX/views/shared/error.cshtml");
