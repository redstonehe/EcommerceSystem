...
namespace VMall.Web.Framework
{
    ...
    public class BaseWebController : Controller
    {
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            //WorkContext.LoginUserType = partUserInfo.IsDirSaleUser ? 2 : 1;
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (filterContext.HttpContext.Request == null)
            {
                ...
                filterContext.Result = RedirectToAction("index", "home", new { area = "mob" });
            }
            
            if ((WebHelper.IsMobile() || WebHelper.IsWechat()) && !WorkContext.IsHttpAjax)
                filterContext.Result = RedirectToAction(WorkContext.Action, WorkContext.Controller, new RouteValueDictionary { { "area", "mob" } });;
                //RedirectToAction(WorkContext.Action, WorkContext.Controller, new RouteValueDictionary { { "area", "mob" } });
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            LogHelper.WriteOperateLog("商城", "错误信息: 来源地址：" + urlReferrer + "  ,当前地址：" + filterContext.HttpContext.Request.Url.AbsoluteUri, "异常方法" + filterContext.Exception.TargetSite + ",\r\n异常信息:" + filterContext.Exception.ToString() + " ,访问者IP：" + WebHelper.GetIP(), (int)LogLevelEnum.ERROR);
            if (WorkContext.IsHttpAjax)
                filterContext.Result = AjaxResult("error", "系统错误,请联系管理员");
            else {
                //filterContext.Result = new ViewResult() { ViewName = "error" };
