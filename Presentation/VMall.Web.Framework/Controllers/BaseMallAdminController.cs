...
namespace VMall.Web.Framework
{
    ...
    public class BaseMallAdminController : Controller
    {
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            WorkContext.OperateRights =new AdminOperateRights().GetRightsByAction(WorkContext.Controller+"_"+WorkContext.Action,WorkContext.MallAGid);
        }
        ...
        protected override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (WorkContext.Uid < 1)
            {
                ...
                {
                    if (!filterContext.Controller.ToString().ToLower().Contains("accountcontroller"))
                        filterContext.Result = new RedirectResult("/");
                    //filterContext.Result = RedirectToAction("default", "account");;
                }
                return;
            }
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            LogHelper.WriteOperateLog("商城管理后台", "错误信息: 来源地址：" + urlReferrer + "  ,当前地址：" + filterContext.HttpContext.Request.Url.AbsoluteUri, "异常方法" + filterContext.Exception.TargetSite + ",\r\n异常信息:" + filterContext.Exception.ToString() + " ,访问者IP：" + WebHelper.GetIP(), (int)LogLevelEnum.ERROR);
            if (WorkContext.IsHttpAjax)
