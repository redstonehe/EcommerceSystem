...
namespace VMall.Web.Framework
{
    ...
    public class WebPager : Pager
    {
        ...
        public sealed override string ToString()
        {
            ...
            if (_showgopage)
            {
                html.AppendFormat("<span class=\"p-skip\"><em>共{2}页 到:</em><input type=\"text\" class=\"input-txt\" value=\"{0}\" id=\"pageNumber\" totalPages=\"{1}\" name=\"pageNumber\" size=\"1\"/><em class=\"marright5\">页</em> <a class=\btn btn-default\" onclick=\"page_goto(this);\" url=\"{3}\" href=\"javascript:;\">确定</a></span>", _pagemodel.PageNumber, _pagemodel.TotalPages, _pagemodel.TotalPages, CreateUrl(_pagemodel.PageNumber));
            }
            html.Append("</div>");
