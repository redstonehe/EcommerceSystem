...
namespace VMall.Web.Models
{
    ...
    public class SuitModel
    {
        ...
        /// 套装折扣
        /// </summary>
        public decimal SuitDiscount { get; set; }
        /// <summary>
        /// 商品合计
        /// </summary>
    ...
    public class ChannelModel
    {
        ...
        /// 一级分类信息
        /// </summary>
        public List<CategoryInfo> FristChannelInfo { get; set; }
        /// <summary>
        /// 二级分类信息
        /// </summary>
        public List<CategoryInfo> SecondChannelInfo { get; set; }
        /// <summary>
        /// 三级分类信息
        /// </summary>
        public List<CategoryInfo> ThirdChannelInfo { get; set; }
        /// <summary>
        /// 选中分类信息
        /// </summary>
        public List<CategoryInfo> CheckCateory { get; set; }
