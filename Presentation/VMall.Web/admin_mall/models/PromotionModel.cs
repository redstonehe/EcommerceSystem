...
namespace VMall.Web.MallAdmin.Models
{
    ...
    public class SinglePromotionModel : IValidatableObject
    {
        ...
        [Range(0, 100, ErrorMessage = "请选择折扣类型")]
        [DisplayName("折扣类型")]
        ...
        [Range(0, double.MaxValue, ErrorMessage = "折扣值不能小于0")]
        [DisplayName("折扣值")]
        ...
        /// 促销海米
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "促销鹿毛不能小于0")]
        [DisplayName("促销鹿毛")]
        [Required(ErrorMessage = "促销鹿毛减免不能为空")]
        public decimal PromoHaiMi { get; set; }

        /// <summary>
        /// 促销PV
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "促销PV不能小于0")]
        [DisplayName("促销PV")]
        [Required(ErrorMessage = "促销PV不能为空")]
        public decimal PromoPV { get; set; }

        /// <summary>
        /// 促销红包减免
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "促销积分比例不能小于0")]
        [DisplayName("促销积分比例")]
        [Required(ErrorMessage = "促销积分比例不能为空")]
        public decimal PromoHongBaoCut { get; set; }
        /// <summary>
        /// 是否秒杀列表显示
        /// </summary>
        [Range(0, 1, ErrorMessage = "是否显示不能小于0大于1")]
        [DisplayName("秒杀列表显示")]
        [Required(ErrorMessage = "秒杀列表显示不能为空")]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (DiscountType == 4 && (DiscountValue <= 0 || DiscountValue >= 10))
                errorList.Add(new ValidationResult("折扣必选大于0且小于10!", new string[] { "DiscountValue" }));
    ...
    public class SuitPromotionModel : IValidatableObject
    {
        ...
        /// 套装海米
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "套装鹿毛不能小于0")]
        [DisplayName("套装鹿毛")]
        [Required(ErrorMessage = "套装鹿毛减免不能为空")]
        public decimal SuitHaiMi { get; set; }

        /// <summary>
        /// 套装PV
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "套装PV不能小于0")]
        [DisplayName("套装PV")]
        [Required(ErrorMessage = "套装PV不能为空")]
        public decimal SuitPV { get; set; }

        /// <summary>
        /// 套装红包减免
        /// </summary>
        [Range(0, double.MaxValue, ErrorMessage = "套装积分比例不能小于0")]
        [DisplayName("套装积分比例")]
        [Required(ErrorMessage = "套装积分比例不能为空")]
        public decimal SuitHongBaoCut { get; set; }
