...
namespace VMall.Web.MallAdmin.Controllers
{
    ...
    public partial class PromotionController : BaseMallAdminController
    {
        ...
        public ActionResult AddSinglePromotion(SinglePromotionModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SinglePromotionInfo singlePromotionInfo = new SinglePromotionInfo()
                {
                    ...
                    PromoHaiMi = model.PromoHaiMi,
                    PromoPV = model.PromoPV,
                    PromoHongBaoCut = model.PromoHongBaoCut,
                    IsShow = model.IsShow,
                    ...
                    Amount5 = model.Amount5,
                    Discount5 = model.Discount5
        ...
        /// </summary>
        [HttpGet]
        public ActionResult BatchAddSinglePromotion()
        {
            SinglePromotionModel model = new SinglePromotionModel();
            LoadSinglePromotionorBatch();
            return View(model);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult BatchAddSinglePromotion(SinglePromotionModel model)
        {
            //if (partProductInfo == null)
            //{
            //    ModelState.AddModelError("Pid", "商品不存在");
            ...
            if (ModelState.IsValid)
            {
                DateTime noTime = new DateTime(1900, 1, 1);
                //拆分商品价格
                string[] PriceInfo = model.PriceInfo.Split(',');
                for (int i = 0; i < PriceInfo.Length; i++)
                {
                    string[] item = PriceInfo[i].Split('-');
                    if (AdminPromotions.AdminIsExistSinglePromotion(TypeHelper.StringToInt(item[0]), model.StartTime1, model.EndTime1) <= 0)
                    {
                        PartProductInfo partProductInfo = AdminProducts.AdminGetPartProductById(TypeHelper.StringToInt(item[0]));
                        if (partProductInfo != null)
                        {
                            SinglePromotionInfo singlePromotionInfo = new SinglePromotionInfo()
                            {
                                Pid = TypeHelper.StringToInt(item[0]),
                                StoreId = partProductInfo.StoreId,
                                StartTime1 = model.StartTime1,
                                EndTime1 = model.EndTime1,
                                StartTime2 = model.StartTime2.HasValue ? model.StartTime2.Value : noTime,
                                ...
                                QuotaUpper = model.QuotaUpper,
                                AllowBuyCount = model.AllowBuyCount,
                                PromoHaiMi = TypeHelper.StringToDecimal(item[1]),
                                PromoPV = TypeHelper.StringToDecimal(item[2]),
                                PromoHongBaoCut = TypeHelper.StringToDecimal(item[3]),
                                IsShow = model.IsShow
                            };
                            AdminPromotions.CreateSinglePromotion(singlePromotionInfo);
                            AddMallAdminLog("添加单品促销", "添加单品促销,单品促销为:" + model.Pid + "_" + model.PromotionName);
        ...
        public ActionResult EditSinglePromotion(int pmId = -1)
        {
            ...
            DateTime noTime = new DateTime(1900, 1, 1);
            PartProductInfo info = Products.GetPartProductById(singlePromotionInfo.Pid);
            if (info == null)
                return PromptView("参加促销的商品不存在");

            SinglePromotionModel model = new SinglePromotionModel();
            model.Pid = singlePromotionInfo.Pid;
            model.Pname = info != null ? info.Name : "";
            ...
            model.PromoHaiMi = singlePromotionInfo.PromoHaiMi;
            model.PromoPV = singlePromotionInfo.PromoPV;
            model.PromoHongBaoCut = singlePromotionInfo.PromoHongBaoCut;
            model.IsShow = singlePromotionInfo.IsShow;
            model.Amount1 = singlePromotionInfo.Amount1;
            model.Discount1 = singlePromotionInfo.Discount1;
            model.Amount2 = singlePromotionInfo.Amount2;
            model.Discount2 = singlePromotionInfo.Discount2;
            model.Amount3 = singlePromotionInfo.Amount3;
            model.Discount3 = singlePromotionInfo.Discount3;
            model.Amount4 = singlePromotionInfo.Amount4;
            model.Discount4 = singlePromotionInfo.Discount4;
            model.Amount5 = singlePromotionInfo.Amount5;
            model.Discount5 = singlePromotionInfo.Discount5;
            LoadSinglePromotion();

            CouponTypeInfo couponinfo = Coupons.GetCouponTypeById(singlePromotionInfo.CouponTypeId);
            string couponTypeName = couponinfo == null ? "无" : couponinfo.Name + "(面值:" + couponinfo.Money + ")";
            ViewData["couponTypeName"] = couponTypeName;
            return View(model);
        }
        ...
        public ActionResult EditSinglePromotion(SinglePromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                singlePromotionInfo.PromoHaiMi = model.PromoHaiMi;
                singlePromotionInfo.PromoPV = model.PromoPV;
                singlePromotionInfo.PromoHongBaoCut = model.PromoHongBaoCut;
                singlePromotionInfo.IsShow = model.IsShow == null ? 0 : model.IsShow;
                singlePromotionInfo.Amount1 = model.Amount1 == null ? 0 : model.Amount1;
                singlePromotionInfo.Discount1 = model.Discount1 == null ? 0 : model.Discount1;
                singlePromotionInfo.Amount2 = model.Amount2 == null ? 0 : model.Amount2;
                singlePromotionInfo.Discount2 = model.Discount2 == null ? 0 : model.Discount2;
                singlePromotionInfo.Amount3 = model.Amount3 == null ? 0 : model.Amount3;
                singlePromotionInfo.Discount3 = model.Discount3 == null ? 0 : model.Discount3;
                singlePromotionInfo.Amount4 = model.Amount4 == null ? 0 : model.Amount4;
                singlePromotionInfo.Discount4 = model.Discount4 == null ? 0 : model.Discount4;
                singlePromotionInfo.Amount5 = model.Amount5 == null ? 0 : model.Amount5;
                singlePromotionInfo.Discount5 = model.Discount5 == null ? 0 : model.Discount5;
        ...
        private void LoadSinglePromotion()
        {
            ...
            discountTypeList.Add(new SelectListItem() { Text = "商城价折扣", Value = "0" });
            discountTypeList.Add(new SelectListItem() { Text = "直降", Value = "1" });
            discountTypeList.Add(new SelectListItem() { Text = "折后价", Value = "2" });
            //discountTypeList.Add(new SelectListItem() { Text = "秒杀价", Value = "3" });
            discountTypeList.Add(new SelectListItem() { Text = "市场价折扣", Value = "4" });
            //discountTypeList.Add(new SelectListItem() { Text = "特价", Value = "5" });
            //discountTypeList.Add(new SelectListItem() { Text = "兑换价", Value = "6" });
            //discountTypeList.Add(new SelectListItem() { Text = "梯度促销价", Value = "7" });
            //discountTypeList.Add(new SelectListItem() { Text = "双数促销价", Value = "8" });
            //discountTypeList.Add(new SelectListItem() { Text = "新品尝鲜价", Value = "9" });
            ...
            //}
            userRankList.Add(new SelectListItem() { Text = "全部", Value = "0" });
            //userRankList.Add(new SelectListItem() { Text = "直销会员", Value = "1" });
            //userRankList.Add(new SelectListItem() { Text = "非直销会员", Value = "2" });
            ViewData["userRankList"] = userRankList;

            ViewData["referer"] = MallUtils.GetMallAdminRefererCookie();
        }

        private void LoadSinglePromotionorBatch()
        {
            List<SelectListItem> discountTypeList = new List<SelectListItem>();
            discountTypeList.Add(new SelectListItem() { Text = "商城价折扣", Value = "0" });
            discountTypeList.Add(new SelectListItem() { Text = "直降", Value = "1" });
        ...
        public ActionResult AddSuitPromotion(SuitPromotionModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                SuitPromotionInfo suitPromotionInfo = new SuitPromotionInfo()
                {
                    ...
                    SuitHaiMi = model.SuitHaiMi,
                    SuitPV = model.SuitPV,
                    SuitHongBaoCut = model.SuitHongBaoCut
                };
        ...
        public ActionResult EditSuitPromotion(int pmId = -1)
        {
            ...
            model.SuitPV = suitPromotionInfo.SuitPV;
            model.SuitHaiMi = suitPromotionInfo.SuitHaiMi;
            model.SuitHongBaoCut = suitPromotionInfo.SuitHongBaoCut;
        ...
        public ActionResult EditSuitPromotion(SuitPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                suitPromotionInfo.SuitHaiMi = model.SuitHaiMi;
                suitPromotionInfo.SuitPV = model.SuitPV;
                suitPromotionInfo.SuitHongBaoCut = model.SuitHongBaoCut;
        ...
        /// </summary>
        [HttpPost]
        public ActionResult AddSuitProduct(int pmId = -1, int pid = -1, decimal discount = -1, int number = 1)
        {
            SuitPromotionInfo suitPromotionInfo = AdminPromotions.AdminGetSuitPromotionById(pmId);
            if (suitPromotionInfo == null)
                return PromptView("此套装促销活动不存在");
        ...
        /// <returns></returns>
        public ActionResult UpdateSuitProductDiscountValue(int pmId = -1, int pid = -1, decimal discount = 0)
        {
