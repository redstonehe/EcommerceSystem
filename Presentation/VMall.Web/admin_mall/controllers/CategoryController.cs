...
namespace VMall.Web.MallAdmin.Controllers
{
    ...
    public partial class CategoryController : BaseMallAdminController
    {
        ...
        public ActionResult AddCategory(CategoryModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                CategoryInfo categoryInfo = new CategoryInfo()
                {
                    ...
                    ChannelId = model.ChannelId == null ? "" : model.ChannelId
                };
        ...
        public ActionResult EditCategory(int cateId = -1)
        {
            ...
            model.ChannelId=categortInfo.ChannelId;
            model.ChannelName = "选择频道";
            List<ChannelInfo> channelList = new List<ChannelInfo>();
            if (!string.IsNullOrEmpty(model.ChannelId)) {
                channelList = AdminChannel.GetChanneListlByWhere(string.Format(" chid in ({0}) ",model.ChannelId));
            }
        ...
        public ActionResult EditCategory(CategoryModel model, int cateId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                categoryInfo.ChannelId = model.ChannelId == null ? "" : model.ChannelId;
        ...
        public ActionResult AttributeList(string sortColumn, string sortDirection, int cateId = -1)
        {
            ...
            string sort = AdminCategories.AdminGetAttributeListSort(sortColumn, sortDirection);
