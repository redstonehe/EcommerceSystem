...
namespace VMall.Web.MallAdmin.Controllers
{
    ...
    public partial class SetController : BaseMallAdminController
    {
        ...
        public ActionResult Site()
        {
            ...
            model.SiteAuthor = mallConfigInfo.SiteAuthor;
        ...
        public ActionResult Site(SiteModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.SiteAuthor = model.SiteAuthor == null ? "" : model.SiteAuthor;
        ...
        public ActionResult Account()
        {
            ...
            model.HMTaxRate = mallConfigInfo.HMTaxRate;
            model.HMFeeRate = mallConfigInfo.HMFeeRate;
            model.YJFeeRate = mallConfigInfo.YJFeeRate;
            model.BankList = mallConfigInfo.BankList;
            return View(model);
        }
        ...
        public ActionResult Account(AccountModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.HMTaxRate = model.HMTaxRate;
                mallConfigInfo.HMFeeRate = model.HMFeeRate;
                mallConfigInfo.YJFeeRate = model.YJFeeRate;
                mallConfigInfo.BankList =CommonHelper.TBBRTrim(model.BankList).Replace("，", ",") ;
                BMAConfig.SaveMallConfig(mallConfigInfo);
                Emails.ResetMall();
                SMSes.ResetMall();
