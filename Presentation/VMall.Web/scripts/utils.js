...
function layerOpenMsgDiv(msg) {
    layer.open({
        ...
        content: '<p class="msgdiv_text">' + msg + '</p>'
        
    });
}

function layerOpen(msg,yesFunc,cancelFunc) {
    layer.open({
        type: 0,
        title: '提示信息',
        btn: '知道了',
...
function layerOpen2(msg, yesFunc, cancelFunc) {
    layer.open({
        type: 0,
        title: '提示信息',
        btn: '知道了',
