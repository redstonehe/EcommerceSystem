...
function OrgShow(OrgNode_) {
    ...
    function GetBoxTemplet() {//取得节点模板
        ...
        var TempletStr = "<div id=\"{Id}\" style=\"cursor: pointer;font-size:14pt;padding:5px 8.5px 5px 5px;border: 2px solid #ccc;-moz-border-radius: 8;-webkit-border-radius: 8px;border-radius:8px;px;background-color:#F7F7F7; clear:left;float:left;text-align:center;position:absolute;"
        if (This.ShowType == 2) TempletStr += "writing-mode: tb-rl;";
        TempletStr += "\" title=\"{Description}\" ><a style=\"color: #666666;text-decoration: none;white-space: nowrap;\" target=\"_blank\">{Text}</a></div>";
