...
namespace VMall.Web.Controllers
{
    ...
    public partial class CatalogController : BaseWebController
    {
        ...
        public ActionResult Product()
        {
            ...
            //热销推荐产品
            model.HotSaleProductList = Products.GetStoreSaleProductList(5, storeInfo.StoreId, 0);
        ...
        public ActionResult OutProduct()
        {
            ...
            //推荐产品
            model.HotSaleProductList = Products.GetStoreSaleProductList(10, storeInfo.StoreId, 0);
